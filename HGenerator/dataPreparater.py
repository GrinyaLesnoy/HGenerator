...
'''
import krita
from HGenerator import HGeneratorDialog
import HGenerator
import importlib
#from HGenerator import DiamondSquare
from HGenerator.modules  import *
...
class HGDataPreparater:
    def __init__(self):
        ...
        self.mainDialog = HGeneratorDialog.HGeneratorDialog()
    ...
    def initialize(self):
        ...
        for file in os.listdir(os.path.join(dir,'modules')):
            if file!='__init__.py' and file.endswith(".py"):
                m = file[:-3]
                #globals()[m]
                mod = importlib.import_module("HGenerator.modules."+ m)
                c = getattr(mod ,m)
                try:
                    name = c.Name
                except:
    ...
    def confirmButton(self):
        ...
        #HGenerator.modules.DiamondSquare.DiamondSquare(Options)
